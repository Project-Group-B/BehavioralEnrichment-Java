		...
		ResultSetExtractor<List<EnrichmentForm>> rowMapper = new ResultSetExtractor<List<EnrichmentForm>>() {
			@Override public List<EnrichmentForm> extractData(ResultSet rs) throws SQLException {
				...
				while(rs.next()) {
					...
					EnrichmentForm.setAnimalIsisNumber(rs.getString("Animal_IsisNumber"));
					EnrichmentForm.setAppovalUserName(rs.getString("u1.User_Name"));
					EnrichmentForm.setDepartmentName(rs.getString("Department_Name"));
					EnrichmentForm.setEnrichmentConcerns(rs.getString("Enrichment_Concerns"));
					EnrichmentForm.setEnrichmentConstruction(rs.getString("Enrichment_Construction"));
					EnrichmentForm.setEnrichmentContact(rs.getString("Enrichment_Contact"));
					EnrichmentForm.setEnrichmentDateSubmitted(rs.getString("Enrichment_DateSubmitted"));
					EnrichmentForm.setEnrichmentDescription(rs.getString("Enrichment_Description"));
					EnrichmentForm.setEnrichmentFrequency(rs.getString("Enrichment_Frequency"));
					EnrichmentForm.setEnrichmentGoal(rs.getString("Enrichment_Goal"));

					EnrichmentForm.setEnrichmentInventory(rs.getString("Enrichment_Inventory"));
					EnrichmentForm.setEnrichmentIsApproved(rs.getString("Enrichment_IsApproved"));
					EnrichmentForm.setEnrichmentLifeStrategies(rs.getString("Enrichment_LifeStrategies"));
					EnrichmentForm.setEnrichmentName(rs.getString("Enrichment_Name"));
					EnrichmentForm.setEnrichmentPresentationMethod(rs.getString("Enrichment_PresentationMethod"));
					EnrichmentForm.setEnrichmentPreviousUse(rs.getString("Enrichment_PreviousUse"));
					EnrichmentForm.setEnrichmentRisksHazards(rs.getString("Enrichment_RisksHazards"));
					EnrichmentForm.setEnrichmentSafetyQuestions(rs.getString("Enrichment_SafetyQuestions"));
					EnrichmentForm.setEnrichmentSource(rs.getString("Enrichment_Source"));
					EnrichmentForm.setEnrichmentTimeEnd(rs.getString("Enrichment_TimeEnd"));

					EnrichmentForm.setEnrichmentTimeRequired(rs.getString("Enrichment_TimeRequired"));
					EnrichmentForm.setEnrichmentTimeStart(rs.getString("Enrichment_TimeStart"));
					EnrichmentForm.setEnrichmentVolunteers(rs.getString("Enrichment_Volunteers"));
					EnrichmentForm.setItemName(rs.getString("Item_Name"));
					EnrichmentForm.setLocationName(rs.getString("Location_Name"));
					EnrichmentForm.setSpeciesName(rs.getString("Species_Name"));
					EnrichmentForm.setSubmittorUserName(rs.getString("u2.User_Name"));
